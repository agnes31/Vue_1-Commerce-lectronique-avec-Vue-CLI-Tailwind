        ...
        <div v-for="(product, i) in inventory" :key="i" class=" w-full max-w-sm  bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
            ...
            <div class="px-5 pb-5 text-center">
                ...
                <div class="flex items-center justify-between mt-2">
                  <input v-model.number="product.quantity" type="number" min="0" class="w-[80px] bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
